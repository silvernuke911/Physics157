...
c_rad = 2/3
a1,a2,a3 = -90*np.pi/180 , -(90+120)*np.pi/180, -(90+240)*np.pi/180
c1 = (c_rad*np.cos(a1),c_rad*np.sin(a1))
c2 = (c_rad*np.cos(a2),c_rad*np.sin(a2))
c3 = (c_rad*np.cos(a3),c_rad*np.sin(a3))
